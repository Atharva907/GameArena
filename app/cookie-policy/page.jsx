      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-6 backdrop-blur-sm md:p-8">
          ...
          <p className="mb-4 leading-8 text-gray-300">
            GameArena uses session cookies to keep users signed in and to secure authenticated actions. Additional local storage is used for non-sensitive preferences such as cart contents and UI state.
          </p>
          <p className="leading-8 text-gray-300">
            No tracking cookies are required for core gameplay, tournament registration, or shop checkout flows.
          </p>
        </div>
      </div>
    </div>
