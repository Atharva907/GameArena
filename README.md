...
Render builds with Node.js 22 and installs build-time dependencies explicitly so the Next.js Tailwind/PostCSS build and Prisma migration command are available.
